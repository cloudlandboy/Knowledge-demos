 ...
 * 消息监听者/接收者
 */
public class UserRoleRecver01 {

    private static final String QUEUE_NAME = "demo_topic_queue_user_role";
    private static final String ROUTINGKEY = "user.role.*";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //将队列绑定到交换机
        channel.queueBind(QUEUE_NAME, RabbitMQUtil.TOPIC_EXCHANGE, ROUTINGKEY);
